...
[![PyPI](https://img.shields.io/pypi/v/fastnest?style=flat-square)](https://pypi.org/project/fastnest/)
...
| Lifecycle hooks | Manual `lifespan` | `OnModuleInit`, `OnApplicationBootstrap` |
| Project scaffolding | Manual | `fastnest new` / `fastnest generate` (CLI) |
...
FastNest ships with a CLI (built on [Typer](https://typer.tiangolo.com/)) for scaffolding new projects and generating boilerplate.

```bash
# Create a new FastNest project
fastnest new my-project

# Generate a module, controller, and service
fastnest generate module users
fastnest generate controller users
fastnest generate service users
```
...
66 passing tests covering dependency injection, module resolution, guards, pipes, interceptors, exception filters, WebSocket gateways, and CLI scaffolding.

---

## Roadmap

- [x] CLI generator (`fastnest generate`, `fastnest new`)
- [x] Testing utilities (66 passing tests, `TestingModule` support)
